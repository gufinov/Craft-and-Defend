...
| F5 — crafting interface and presentation quality | Tab-only inventory, B hand crafting, right-click station menus, three-panel 2×2/3×3 crafting, stable camera/sun presentation; castle-system plan | T31–T36 plus F2–F4 regression | Revised candidate passes editor automation and 1280×720 render; Windows export and owner motion/ultrawide review pending |
