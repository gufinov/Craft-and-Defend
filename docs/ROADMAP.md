...
| P3H.1 — item atlas alignment repair | Isolated recipe-card cells, complete long-item silhouettes and corrected held framing | Strengthened T91/T92, T103 and owner ultrawide playtest | Candidate PASS; owner playtest pending |
| P3H.2 — held scale and unified alpha art | Enlarged common tool frame, broad strike travel, doubled low-held scale and one RGBA inventory/held atlas | Strengthened T91/T92/T103, T104 and owner ultrawide playtest | Implementation ready for exported validation |
