...
| P1B — first castle kit | Wall masonry plus stair, wall-walk slab, parapet merlon, 2×2 tower platform and open gate frame; preview, rotation, support, dismantle and save | T42–T46 plus construction playtest | Active candidate |
...
P1A established dependable terrain and exploration. P1B now tests the first original structural kit and the reusable placement contract. Its current whole-piece 90-degree rotation, count-based prototype recipes, explicit supports and no-collapse behavior are candidate decisions awaiting owner building-feel acceptance. Defensive mounts and one stationary weapon join P3; player equipment follows an explicit combat contract; magic remains a later reviewed track. See [Castle construction and crafting plan](CASTLE_CONSTRUCTION_AND_CRAFTING.md).
