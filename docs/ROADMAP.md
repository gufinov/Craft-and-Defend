...
| F4 — Foundation acceptance | Day/night, material readability, UI/resolution review, portable package, rebindable in-game capture | T27–T30 and full acceptance | Implementation PASS; owner playtest pending |
