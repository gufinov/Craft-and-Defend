...
|---|---|---|---|---|
| T79 | Shift+Click is exactly five atomic batches | Five Logs became 20 Planks in one revision; four Logs returned `INSUFFICIENT_INPUT` with identical snapshot | PASS | `manual-p3d-usability-310016020/phase1` log/JSON |
...
| Regression | Accepted crafting/combat/build behavior remains green | P3C T72–T77, P3B T66–T69 and F5 T31/T33/T35/T36 pass from final export | PASS | `final-p3c-regression-a724838`, `final-p3b-regression-a724838`, `final-f5-regression-a724838` |
| Windows export | Matching custom release template with editor closed | Provenance check accepted game tree `28541a8...`; phase and visible-render processes passed | PASS | build manifest and one-click output |

Final one-click root: `artifacts/manual-p3d-usability-310016020`. Final independently inspected renders: `artifacts/final-p3d-visual-a724838/p3d-held-axe-iron-marker.png` SHA-256 `010bc45c5ada5051b233a8779baee224a5b1476bc1e516e0dbd4320322b477ba`; `p3d-held-block-placement-ghost.png` SHA-256 `43f8a1a67adc324b55965180b9a0c5d3098f8943a54cccfb0da18672af59756a`.
...
- Repo, branch, commit, worktree: `D:\CODEX\Craft_and_Defend`; `feature/p3d-tools-world-feedback`; implementation/export source `a72483898f12b3085bb626682cd5ebda41814d0c`; game tree `28541a8fd767aa21100071eff9817ed0a810cf6f`; `D:\CODEX\Craft_and_Defend\worktrees\p3d-tools-world-feedback`.
...
- Build artifact SHA-256: EXE `4ac128729e86108904e6d038d161322404d42d71892b1cc0dca751039aa7e4b2`; PCK `d40bc1b075518b8c98b50539edce90b7050a4c294305112ca03c0cb0874626de`; built UTC `2026-09-13T16:47:25.2310013Z`.
