...
STATUS: PARTIAL — castle implementation, corrected three-section inventory, matching export and automated gates pass; owner ultrawide UI/building acceptance remains pending.
...
| T47 | Distinct carried, hotbar and armor regions | 18 carried controls map to authoritative slots 10–27; one nine-control row maps to slots/keys 1–9; six armor positions are present and disabled | PASS | `artifacts/inventory-visual-final.log`, `artifacts/inventory-ultrawide-final.log`, `artifacts/export-inventory-layout.log` |
| T48 | Inventory layout readable at supported viewports | Windows-rendered 1280×720 and 1720×720 logical-ultrawide captures passed, were visually inspected and showed no clipping; owner physical 3440×1440 review pending | PARTIAL | `artifacts/inventory-visual-final-data/p1-inventory-loadout-1280x720.png`, `artifacts/inventory-ultrawide-final-data/p1-inventory-loadout-1720x720.png` |
...
- Carried inventory remains 18 uniform stack slots. A spatial/variable-footprint alternative is recorded as a later whole-system decision rather than silently changing current capacity or saves.
...
Tony launches `D:\CODEX\Craft_and_Defend\worktrees\p1-castle-kit\START_GAME.cmd`, opens Tab on the 3440×1440 display, verifies the three regions and moves one item between Carried and Hotbar. He then completes the pending castle-piece build/collision test. Address findings before P2 navigation work or integration.
...
- Implementation/export source: `774a25f8ecd80304c4d33ac396fed376dc2b061f`; game tree `9ddb362fce6b32e9db69cee93eae4b6a2e8f1c7d`; accepted terrain base `9a38a3321c23c0816dabec74056c1017a6129d28`.
...
- Export EXE SHA-256: `4ac128729e86108904e6d038d161322404d42d71892b1cc0dca751039aa7e4b2`; PCK SHA-256: `b7ce8191b15c9d3dc73cabb40c0a222b7bb6e0a95f49e56d22359a6232ad2ffe`; built UTC `2026-09-12T13:11:09.5430580Z`.
