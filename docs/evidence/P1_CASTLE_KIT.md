# Evidence — P1B first castle kit — 2026-09-13

STATUS: PARTIAL — castle implementation, owner-accepted draggable/category-organized inventory and walkable two-step stair export pass; owner physical stair-feel acceptance remains pending.
...
| T50 | Two-step stair and bounded automatic traversal | Two repeated editor runs and the editor-closed export climbed `1.0507` blocks and advanced `3.0004` blocks under Forward without Jump; the full-block guard gained `0.0` height and stopped after `0.6497` blocks | PASS | `artifacts/stair-repeat-1.log`, `artifacts/stair-repeat-2.log`, `artifacts/export-stair-phase1.log` |
...
| Static | Contract equality, exact two-part stair geometry, required item categories, structure validation and rejection tests | Validator PASS; 26/26 unit tests PASS | PASS | commands below |
...
- Owner physical two-step stair traversal and feel remain unverified.
...
- The first stair-walk fixture approached over an unfilled valley cell and fell before contact (`climbed_height=0`, `forward_distance=0.1491`). Explicit approach/landing cells corrected that setup. A default-snap experiment then failed to settle the raised capsule, so extended snap was restored only on successful step frames. Finally, the fixture was made deterministic by waiting for voxel collision rebuild and grounded state; two consecutive editor runs and the exported run then produced identical T50 results.
...
Tony launches `D:\CODEX\Craft_and_Defend\worktrees\p1-castle-kit\START_GAME.cmd`, builds a two- or three-block stair run, walks and sprints up without Jump, walks down and confirms a normal full block remains a barrier. Address findings before P2 navigation work or integration.
...
- Implementation/export source: `41bb0ebea13e3cc6f8270ae8fcd7eb10c50e41f9`; game tree `28215de4c56dff2de1af84cd2eaa6dd198a861c4`; accepted terrain base `9a38a3321c23c0816dabec74056c1017a6129d28`.
...
- Export EXE SHA-256: `4ac128729e86108904e6d038d161322404d42d71892b1cc0dca751039aa7e4b2`; PCK SHA-256: `1bc0fb3aef187cb9accf5cf51efeb5b9d056cf442d1e6bce4945c2c2fed19073`; built UTC `2026-09-13T01:03:56.9824079Z`.
