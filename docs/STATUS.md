...
**STATUS:** **ROUND-2 BUILD + ROUND-3/4/5/6 FIXES + COASTER RAILS MERGED — CANDIDATE PASS ON THE EXPORT (PCK `91aa8669…`, branch `feature/p3d-tools-world-feedback`, pushed); OWNER RE-PLAYTEST PENDING; NOT MERGED TO `main`.**
...
**TEST:** Static PASS. Exported PCK `91aa8669…` (EXE `4ac12872…`): all thirteen runners PASS — `TEST_COASTER_RAILS` (T160–T163), `TEST_P4_SIEGE_UNITS` (T130–T136, T141–T143, T147, T151–T155), `TEST_P4_ASSETS` (T148–T150), `TEST_P4_ENEMY_UNITS`, `TEST_P4_WEAPON_PANEL` (T123 three consecutive passes in the editor after the click fix), `TEST_P4_RESOURCES`, `TEST_P3C`, `TEST_P3G`, `TEST_P3D`, `TEST_P3F`, `TEST_P3K`, `TEST_P3E`, `TEST_P3H`. Editor gates coaster, siege units, assets, P3C, P3F, P3D, P3K, weapon panel, P3G, P3B PASS at the merge. Owner playtest NOT RUN.
...
**GIT/REPRODUCIBILITY:** Worktree `D:\CODEX\Craft_and_Defend\worktrees\p3d-tools-world-feedback`, branch `feature/p3d-tools-world-feedback`, pushed; `feature/p4-core-and-lights` (`e8ffeb5`) and `feature/coaster-rails` (`7f2cdd9`, pushed) merged. Engine `4.6.stable.custom_build.89cea1439`; EXE SHA-256 `4ac128729e86108904e6d038d161322404d42d71892b1cc0dca751039aa7e4b2`; PCK SHA-256 `91aa86697858582d95095201453dced9d62e3ac531d52061419ed700520bac88`. Evidence roots: the newest `artifacts/manual-*` folder per runner from the 2026-09-19 sweep (scratch `runall.log`).
