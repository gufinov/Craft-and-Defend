...
- The primary card and world-reference paths resolve `item_atlas_p3h2.png`; P3H.3 routes only Ballista Bolt and Stone Shot through `ammunition_atlas_p3h3.png`. Every extracted region remains filter-clipped and no RGB card-background atlas is active.
