...
| T163 | Coaster | Visual: a size-6 loop element (switchers, slopes and the round circle) renders with a mine cart on it, beside a slope run climbing a step with its own cart, in one 1280×720 view (`coaster-rails.png`) |
