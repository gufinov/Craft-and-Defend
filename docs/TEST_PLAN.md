...
| T172 | CoasterCraft | Visual: a six-long Smooth Switch and an eight-long two-lane Crossing render with lead-in / exit rails and a mine cart riding each, the shared cells drawing both tracks, in one 1280×720 view (`coaster-smooth.png`) |
