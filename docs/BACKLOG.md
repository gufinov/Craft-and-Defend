...
**Recorded candidate result:** Tony rejected the first day/night presentation as imperceptible; inspection also found the displayed time and solar position misaligned. The revised candidate starts new worlds at visible 08:00 sunrise, adds a sun and a scrollable in-session World Settings accordion for validated time and cycle control, and persists both time and cycle-enabled state per slot. Tony accepted the revised day/night and World Settings behavior on 2026-09-11. His acceptance playtest then exposed an overly strict below-only voxel-support rule; the exported repair now accepts any solid neighboring face while preserving rejection of truly floating, occupied, out-of-bounds and player-overlap placement. Final T05/T06 phase1 and clean-process Continue phase2 pass; owner retest of the placement repair is pending. Weather/console controls are deferred until implemented systems justify them. Do not begin P1, merge, push or publish without explicit authority.
