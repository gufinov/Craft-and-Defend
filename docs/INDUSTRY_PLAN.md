...
| | | **Status 2026-09-21: built** on `feature/coastercraft-shop` - see docs/COASTER_RAILS.md "CoasterCraft Shop (2026-09-21)"; T192 (p3f), T160 / T164 updated; recipe 4 iron + 3 planks + 2 sticks (the 3 × 3 grid caps a recipe at 9 inputs). |
