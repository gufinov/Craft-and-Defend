...
> **Checkpoint update (2026-09-15):** This was the original F0 commission and is retained for provenance. F0–F5 and P1–P3F are owner-accepted. P3G Furnace usability, P3H balance/fuel/controls, P3H.1 atlas alignment and P3H.2 held scale/unified alpha are isolated passing candidates awaiting owner playtest. P3H supersedes one-Coal-per-item behavior with counted 1:3 work. Use [current status](STATUS.md), [roadmap](ROADMAP.md), [P3H.2 contract](P3H2_HELD_SCALE_AND_ALPHA.md), [future balance/ecology/siege contract](BALANCE_ECOLOGY_AND_SIEGE_SYSTEMS.md), [castle construction and crafting plan](CASTLE_CONSTRUCTION_AND_CRAFTING.md) and recorded evidence for current truth. The historical instructions below are not a fresh commission.
