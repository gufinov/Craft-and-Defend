...
> **Checkpoint update (2026-09-14):** This was the original F0 commission and is retained for provenance. F0–F5 and P1–P3F are owner-accepted. P3G Furnace usability and P3H balance/fuel/controls are the current isolated candidates. P3H supersedes one-Coal-per-item behavior with counted 1:3 work. Use [current status](STATUS.md), [roadmap](ROADMAP.md), [P3H contract](P3H_BALANCE_FUEL_AND_CONTROLS.md), [future balance/ecology/siege contract](BALANCE_ECOLOGY_AND_SIEGE_SYSTEMS.md), [castle construction and crafting plan](CASTLE_CONSTRUCTION_AND_CRAFTING.md) and recorded evidence for current truth. The historical instructions below are not a fresh commission.
