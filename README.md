...
**Status: F0–F5 and P1–P3B are owner accepted; P3C plus its P3D usability extension is a matching-export candidate awaiting Tony's playtest.** P3D adds atomic Shift+Click five-batch crafting, visible held items and block ghosts, a Wood Axe, and an in-world cue for the existing starter iron vein while retaining the accepted ESDF controls, persistence, castle construction and defense foundation. Craft-and-Defend is a working label; final branding is open.
...
4. Review [current P3D evidence](docs/evidence/P3D_TOOLS_AND_WORLD_FEEDBACK.md) and the earlier records in [the documentation index](docs/INDEX.md) before promoting another milestone.
