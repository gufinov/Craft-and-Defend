# P3D candidate runtime

The Godot project contains the owner-accepted foundation through P3B and the combined P3C/P3D candidate. P3D adds immediate crafting and first-person build/tool feedback without claiming waves, player health, workers, rifts, multiplayer or campaign expansion.
...
Launching from official/vanilla Godot is rejected before gameplay loads with `FATAL_TOOLCHAIN_MISMATCH` and the missing Voxel Tools classes. See `docs/evidence/F3_PERSISTENCE_HARDENING.md` for the accepted dependency baseline and `docs/evidence/P3D_TOOLS_AND_WORLD_FEEDBACK.md` for this candidate's results.
