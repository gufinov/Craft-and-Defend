...
6. Open **Settings** to change look sensitivity, vertical inversion, master volume, window mode or resolution. Display changes require confirmation and revert after ten seconds.
