...
const ITEM_CATEGORY := {
	...
	"gate": "construction",
	"double_gate_frame": "construction",
	"double_gate": "construction",
	"great_gate_frame": "construction",
	"great_gate": "construction",
	"wood_barricade": "construction",
	"sign": "construction",
	"sign_board": "construction",
	"sign_board_large": "construction",
	...
	"tar_patch": "siege_and_defense",
	"wall_blades": "siege_and_defense",
	"spring_plate": "siege_and_defense",
	"ceiling_dropper": "siege_and_defense",
