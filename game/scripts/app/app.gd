...
func _hide_all_panels() -> void:
	for panel in [menu_panel, coastercraft_menu_panel, pause_panel, coastercraft_pause_panel, keybind_panel, settings_panel, inventory_panel, crafting_panel, sign_panel, display_confirm_panel, loading_panel, hud_layer]:
		if panel != null:
			panel.hide()
