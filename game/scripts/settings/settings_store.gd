...
const ACTION_LABELS := {
	...
	"rotate_build": "Rotate Build Preview",
...
const ACTION_CONTEXTS := {
	...
	"interact": "gameplay", "inventory": "gameplay", "build": "gameplay", "rotate_build": "gameplay", "pause": "system",
...
const DEFAULT_BINDINGS := {
	...
	"rotate_build": {"kind": "key", "code": KEY_X},
